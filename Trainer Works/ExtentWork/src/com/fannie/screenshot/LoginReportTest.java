...
public class LoginReportTest {
	...
	public void test() {
		...
		WebElement subBtn = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/form/div[3]/div/button"));
		subBtn.click();
	...
	@Test
	public void another() {
		test.log(LogStatus.ERROR, "for testing fatal ");
	}

	@Test
	public void another1() {
		test.log(LogStatus.FAIL, "for testing fail");
	}
